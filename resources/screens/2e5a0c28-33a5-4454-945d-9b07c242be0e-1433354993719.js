jQuery("#simulation")
  .on("click", ".s-2e5a0c28-33a5-4454-945d-9b07c242be0e .click", function(event, data) {
  ...
  .on("pageload", ".s-2e5a0c28-33a5-4454-945d-9b07c242be0e .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swipeleft", ".s-2e5a0c28-33a5-4454-945d-9b07c242be0e .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
