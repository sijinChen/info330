jQuery("#simulation")
  .on("click", ".s-aad76779-0772-495c-8208-6ed29c30d443 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/db2caa16-e535-4a28-826c-20e35bbdc81c",
                    "transition": "slideleft"
                  }
                }
              ]
  ...
  .on("pageload", ".s-aad76779-0772-495c-8208-6ed29c30d443 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swipeleft", ".s-aad76779-0772-495c-8208-6ed29c30d443 .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swiperight", ".s-aad76779-0772-495c-8208-6ed29c30d443 .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
