jQuery("#simulation")
  .on("click", ".s-3b76c03a-f66d-463f-b927-e8b310e57014 .click", function(event, data) {
  ...
  .on("swiperight", ".s-3b76c03a-f66d-463f-b927-e8b310e57014 .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
