jQuery("#simulation")
  .on("click", ".s-5f262bd2-b4ed-4e83-af83-9e79d39bd45a .click", function(event, data) {
  ...
  .on("pageload", ".s-5f262bd2-b4ed-4e83-af83-9e79d39bd45a .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swipeleft", ".s-5f262bd2-b4ed-4e83-af83-9e79d39bd45a .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/e7f8ed0f-ad18-4c76-8958-66738ca4754f",
