jQuery("#simulation")
  .on("click", ".s-414921c9-bf56-484b-a5d1-a6546483c943 .click", function(event, data) {
  ...
  .on("pageload", ".s-414921c9-bf56-484b-a5d1-a6546483c943 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swipeleft", ".s-414921c9-bf56-484b-a5d1-a6546483c943 .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swiperight", ".s-414921c9-bf56-484b-a5d1-a6546483c943 .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
