jQuery("#simulation")
  .on("click", ".s-a1dbe9e0-b7cf-4993-b251-ca2d8c2c00c1 .click", function(event, data) {
  ...
  .on("pageload", ".s-a1dbe9e0-b7cf-4993-b251-ca2d8c2c00c1 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swipeleft", ".s-a1dbe9e0-b7cf-4993-b251-ca2d8c2c00c1 .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
