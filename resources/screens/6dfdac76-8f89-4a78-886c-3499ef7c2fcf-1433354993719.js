jQuery("#simulation")
  .on("click", ".s-6dfdac76-8f89-4a78-886c-3499ef7c2fcf .click", function(event, data) {
  ...
  .on("pageload", ".s-6dfdac76-8f89-4a78-886c-3499ef7c2fcf .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swipeleft", ".s-6dfdac76-8f89-4a78-886c-3499ef7c2fcf .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swiperight", ".s-6dfdac76-8f89-4a78-886c-3499ef7c2fcf .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
