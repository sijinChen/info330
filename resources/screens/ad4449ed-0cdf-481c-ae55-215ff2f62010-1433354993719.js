jQuery("#simulation")
  .on("click", ".s-ad4449ed-0cdf-481c-ae55-215ff2f62010 .click", function(event, data) {
  ...
  .on("swipeleft", ".s-ad4449ed-0cdf-481c-ae55-215ff2f62010 .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
